...
class ThemeSwitcher
{
    ...
    {
        add_theme_page(
            __( 'Theme Switcher', 'theme-switcher' ),
            // Page title
            __( 'Theme Switcher', 'theme-switcher' ),
            // Menu title
            'manage_options',
    ...
    public function settings_init(): void
    {
        ...
        add_settings_section(
            'theme_switcher_main',
            // Section ID
            __( 'Theme Settings', 'theme-switcher' ),
            // Title
            [ $this, 'section_text' ],
            // Callback function
            'theme-switcher'
        ...
        add_settings_field(
            ...
            // Field ID
            __( 'Select Theme', 'theme-switcher' ),
            // Title
            [ $this, 'setting_input' ],
            // Callback function
            'theme-switcher',
     ...
     */
    public function setting_input(): void
    {
        $options       = get_option( 'theme_switcher_options' );
        $current_theme = $options['theme'] ?? wp_get_theme()->get_stylesheet();
